...
internal abstract class NavigatingActivity : Activity() {
  ...
  fun resetTo(screen: Screen) {
    ...
    currentView.startAnimation(loadAnimation(this, R.anim.thread_canary_exit_alpha))
    ...
    currentView = currentScreen.createView(container)
    currentView.startAnimation(loadAnimation(this, R.anim.thread_canary_enter_alpha))
    container.addView(currentView)
  ...
  fun goTo(screen: Screen) {
    ...
    currentView.startAnimation(loadAnimation(this, R.anim.thread_canary_exit_forward))
    container.removeView(currentView)
    currentView.notifyScreenExiting()
    ...
    currentScreen = screen
    currentView = currentScreen.createView(container)
    currentView.startAnimation(loadAnimation(this, R.anim.thread_canary_enter_forward))
    container.addView(currentView)
  ...
  fun goBack() {
    ...
    currentView.startAnimation(loadAnimation(this, R.anim.thread_canary_exit_backward))
    container.removeView(currentView)
    currentView.notifyScreenExiting()
    ...
    currentView = currentScreen.createView(container)
    currentView.startAnimation(loadAnimation(this, R.anim.thread_canary_enter_backward))
